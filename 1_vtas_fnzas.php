    ...
    <form action="" class="m-5">
        ...
        <div class="p-5" style="background-color:aliceblue">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                    Se cuenta con los mínimos protocolos de venta, para conectar con clientes de manera presencial y virtual.
                </label>
            </div>
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
        ...
        <div class="p-5" style="background-color:antiquewhite">
            ...
            <div class="form-check mx-4">
                <input class="form-check-input" type="radio" name="" id="">
                <label class="form-check-label" for="">
                    Se cuenta con un programa anual de promociones además de un plan de lealtad con privilegios exclusivos.
                </label>
            </div>
        </div>
        ...
        <div class="col-md-2 p-2"> 
            <p class="pregunta">Gestión de venta</p>
        </div>
        <div class="col-md-2 p-2 border_respuestas">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p1" value="1" id="s1p1">
              <label class="form-check-label" for="s1p1">
                No se cuenta con una labor de venta específica, solo la atención de clientes que nos buscan.
              </label>
            </div>
        </div>
        <div class="col-md-2 p-2 border_respuestas">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p1" value="2" id="s1p1">
              <label class="form-check-label" for="s1p1">
              Se cuenta con los mínimos protocolos de venta, para conectar con clientes de manera presencial y virtual.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p1" value="3" id="s1p1">
              <label class="form-check-label" for="s1p1">
              Solo se cuenta con seguimiento manual.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p1" value="4" id="s1p1">
              <label class="form-check-label" for="s1p1">
              Se cuenta con un CRM para la integración y monitorio de los pacientes actuales y  posibles nuevos.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p1" value="5" id="s1p1">
              <label class="form-check-label" for="s1p1">
              Se cuenta con un CRM que es explotado y aprovechado al máximo nivel .
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_preguntas_medio"> 
            <p class="pregunta">Actividad Promocional</p>
        </div>
        <div class="col-md-2 p-2 border_respuestas_medio">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p2" value="1" id="s1p2">
              <label class="form-check-label" for="s1p2">
              No se cuenta con actividad promocional.
              </label>
            </div>
        </div>
        <div class="col-md-2 p-2 border_respuestas_medio">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p2" value="2" id="s1p2">
              <label class="form-check-label" for="s1p2">
              Se cuenta con promoción solo en algunas fechas importantes.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas_medio">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p2" value="3" id="s1p2">
              <label class="form-check-label" for="s1p2">
              Se cuenta con promoción fechas importantes y en servicios específicos a lo largo del año.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas_medio">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p2" value="4" id="s1p2">
              <label class="form-check-label" for="s1p2">
              Se cuenta con un programa anual de promociones aprovechando las temporalidades de año.
              </label>
            </div>
        ...
        <div class="col-md-2 p-2 border_respuestas_medio">
            <div class="form-check mx-4">
              <input class="form-check-input" type="radio" name="s1p2" value="5" id="s1p2">
              <label class="form-check-label" for="s1p2">
              Se cuenta con un programa anual de promociones además de un plan de lealtad con privilegios exclusivos.
              </label>
            </div>
